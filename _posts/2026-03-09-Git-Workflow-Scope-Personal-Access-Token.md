...
7. Change the token in your project to the new one with the workflow scope Note that you may not need to do steps 6 and 7, it’s best to try your push again after updating to confirm.
